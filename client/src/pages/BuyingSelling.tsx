    ...
    <div id="top" className="bs-page">
      ...
      <main id="main-content" tabIndex={-1}>
        <section className="bs-hero">
          ...
          <div className="bs-hero__photo"><ResponsiveImage src={heroImage} sizes="(max-width: 1180px) 100vw, 50vw" priority alt="Mary Lynch working on the phone beside an open laptop" /><p className="bs-hero__experience-caption"><strong>30 YEARS</strong><span>of helping Baltimore-area families make thoughtful real estate decisions.</span></p></div>
        </section>

        <section id="choose" className="bs-choice">
          <div className="bs-section-intro"><p className="bs-eyebrow">Choose your path</p><h2>When the decision is clear, <i>the next step can be too.</i></h2><p>Whether you are preparing to sell, beginning to look, or considering both at once, Mary brings the transaction experience and the perspective to help you move with intention.</p></div>
        ...
        <section id="buying" className="bs-buying">
          <div className="bs-section-number">01 <span>/</span> BUYING</div>
        ...
        <DeferredBackground id="selling" className="bs-selling" backgroundImage={`linear-gradient(rgba(16,42,67,.96), rgba(16,42,67,.96)), url(${contourTexture})`}>
          <div className="bs-section-number bs-section-number--light">02 <span>/</span> SELLING</div>
        ...
        <DeferredBackground className="bs-closing site-closing-strip" backgroundImage={`url(${paperTexture})`}><div className="site-closing-strip__content"><div className="site-closing-strip__heading"><p className="bs-eyebrow">Experienced guidance, without pressure</p><h2>Real estate is the transaction. <i>The plan is the bigger picture.</i></h2></div><div className="site-closing-strip__copy"><p>Mary brings 30 years of residential real estate experience to the table, along with the patience to understand what surrounds the move: family, timing, belongings, finances, and what you want daily life to feel like next.</p></div></div></DeferredBackground>
      </main>
