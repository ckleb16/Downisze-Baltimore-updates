...
export default function AgingInPlace() {
  return <div className="aip-page"><SiteHeader currentPath="/aging-in-place" /><main id="main-content" tabIndex={-1}>
    ...
    <DeferredBackground className="aip-final" backgroundImage={`url(${paperTexture})`}><div className="aip-final__frame"><Anchor size={30} /><p className="aip-eyebrow">A clearer decision starts early</p><h2>The Goal Is Not to Stay at All Costs.<br /><i>And It Is Not to Move Before You’re Ready.</i></h2><p>The goal is to understand your options early enough that the decision is still yours.</p><p>Whether that means making your current home safer, creating a multigenerational solution, finding a home that better fits the years ahead, or simply beginning the conversation, having a plan can make all the difference.</p><ButtonLink>Schedule a Conversation</ButtonLink></div></DeferredBackground>
